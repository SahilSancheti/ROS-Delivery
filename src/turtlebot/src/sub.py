...
from turtlebot.msg import TimestampString
...
def callback(data):
    ...
    print "Message:", data.message, "Received at:", rospy.get_time() 
...
def listener():
    ...
    rospy.Subscriber("turtlebot_dest", TimestampString, callback)
